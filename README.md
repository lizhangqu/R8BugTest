...
Actually `com.vdian.android.lib.vdplayer.player.IMediaPlayer` should not be obfuscated because it's just be provided and it's not configured with mapping rule in the mapping.txt.
